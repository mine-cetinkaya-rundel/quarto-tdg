...
``` {.yaml filename="_quarto.yml"}
{{< include temp-dirs/ds-project2/_quarto.yml >}}
```
...
Using `_quarto.yml` can help reduce duplication in the metadata of your documents, but once you have related documents in a project, you often also find you have duplicated content. 

To avoid duplicating content across documents you can make use of includes and embeds.

See ... Or talk about here.

...
- Accessing info about your document from your R session: Conditional Execution

- Knitr and R options

- Quarto R package -- rendering from code

- https://quarto.org/docs/computations/render-scripts.html#knitr

- https://quarto.org/docs/computations/execution-options.html#raw-output -- do for python too

...
#### `margin` {#fig-typst-layout-columns}
...
You can use anything Typst will recognize as a [relative length](https://typst.app/docs/reference/layout/relative/) and includes simple lengths with units like `2cm`, `1in`, `254mm`, ratios like `10%`, and combinations like `25% + 1cm`.
...
When you place content outside the body column, e.g. in the margin or across the full page-width, as desribed in @sec-typst-full-width-margin, the layout switches to use the Typst [marginalia package](https://typst.app/universe/package/marginalia/).

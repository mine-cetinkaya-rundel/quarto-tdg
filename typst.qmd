...
The advantage of HTML tables (@sec-html-tables), is that cell-level formatting, like coloring that depends on the data, will be preserved. 
...
If none of the techniques in this section reach your needs, you'll might need the techniques in @sec-advanced-customization.
...
Most of the time the strategies in @sec-customizing-appearance will be enough to get a document that meets your needs, but there are limitations to those strategies.
...
These functions take the existing element as input and can return anything, but usually you'll return a transformed version of the input.

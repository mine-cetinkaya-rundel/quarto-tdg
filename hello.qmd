...
Quarto is an open-source scientific and technical publishing system built on Pandoc[^hello-1].
...
[^hello-1]: Pandoc is a tool that converts documents to different formats.

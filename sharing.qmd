...
For more details on specific providers and other ways to share documents, see @sec-website-publish.
...
You'll learn a bit more about the providers later in this chapter, but let's use Posit Connect Cloud for illustration.

::: callout-tip
[Posit Connect Cloud](https://connect.posit.cloud) has a free tier with unlimited static documents.
To follow along, you'll need to [**Sign Up**](https://connect.posit.cloud) for an account first.
:::

Quarto will prompt you to authorize your account when you select a Provider for the first time.
This looks different for each provider, but for Posit Connect Cloud, you'll be asked to authorize your account via your default internet browser:
...
Once done, Quarto will give you a URL to view your published content, as shown in @fig-posit-connect-cloud.

![After publishing, Quarto opens a browser to the content view on Posit Connect Cloud.](images/publishing-posit-connect-cloud.png){#fig-posit-connect-cloud fig-alt="Screenshot of the admin view of a published document on Posit Connect Cloud."}

The URL Quarto returns is for managing your content, not for sharing.
To find your shareable URL, navigate to **Settings** > **URL**, as shown in @fig-posit-connect-cloud-settings.

![The Settings > URL page shows the Default URL for sharing your content.](images/publishing-posit-connect-cloud-settings.png){#fig-posit-connect-cloud-settings fig-alt="Screenshot of the Settings URL page on Posit Connect Cloud showing the Default URL."}

Shareable URLs end in `.share.connect.posit.cloud`.
By default, URLs use an auto-generated identifier, but you can customize them to something memorable like `cwickham-document.share.connect.posit.cloud`.
Share the URL and anyone can view your rendered content.
...
- source: document.qmd
  posit-connect-cloud:
    - id: 019cd4a5-d2da-c2cf-f7f9-dc78e0748f72
      url: 'https://connect.posit.cloud/cwickham/content/019cd4a5-d2da-c2cf-f7f9-dc78e0748f72'
```

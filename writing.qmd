...
You'll learn to structure your document with headings, create paragraphs and lists, format text, and include images.

For more advanced authoring features like tables, equations, cross-references, citations, callouts, and layout, see @sec-authoring.

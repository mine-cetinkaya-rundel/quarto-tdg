...
Learn how to implement [hybrid navigation in the Quarto documentation](https://quarto.org/docs/websites/website-navigation.html#hybrid-navigation).
...
To make a link look like a button, use the usual syntax, but add the classes, not forgetting a `.`, in curly braces:

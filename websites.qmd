...
I can't tell if this is really fully supported. It certainly doesn't look like what I thought was true is. Example does not work.
...
:::{}
![Page in the Guide](images/website-hybrid-guide.png)

![Page in the Reference](images/website-hybrid-reference.png)
:::
...
However, if you aren't using **brand.yml** across projects, or formats, it may be easier to specify it directly in `_quarto.yml` as shown in @sec-sec-websites-navigation.
...
For example, the theme `lux`, explicitly sets a color for headings which doesn't work well with a dark background. 
...
@tbl-boostrap-classes gives some examples of applying Bootstrap classes to spans, divs, images and tables.



For instance, the [Badge component classes](https://getbootstrap.com/docs/5.3/components/badge/) can apply to a span in a header:

```{.html}
<h3>Example heading <span class="badge text-bg-secondary">New</span></h3>
```

To use this in Quarto, use the span syntax inside a markdown header:
```{.markdown}
### Example heading [New]{.badge .text-bg-secondary}
```

When rendered, this adds a 
::: {.border .p-2}
### Example heading [New]{.badge .text-bg-secondary}
:::

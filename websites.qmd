...
knowing a little,  open up some other areas for customization.

You can use Bootstrap classes on divs and spans to include Bootstrap components

You can use Bootstrap SCSS variables to alter appearance at a more global level than by adding CSS rules.

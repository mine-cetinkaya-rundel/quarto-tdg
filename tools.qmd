...
**Rendering:** Use the **Quarto: Preview** command or the **Preview** button in the toolbar to render `.qmd` files to HTML, PDF, Word, or other formats.
...
**Polyglot language support:** Positron provides first-class support support for working seamlessly with R and Python within your documents, making it an excellent choice for data science projects in either language or in projects that use both languages.
...
**Code completion and diagnostics:** Positron provides provides code completion and diagnostics that offer intelligent suggestions and error checking for Quarto-specific syntax.
...
- **Dual editor modes:** Switch between source and visual editing modes using the buttons in the toolbar or the keyboard shortcut (⌘⇧M on macOS, Ctrl+Shift+M on Windows/Linux).
...
Like Positron, RStudio also offers an in integrated terminal and Git integration.

The document outlinelooks a bit different in RStudio, located in the editor pane.
...
::: todo
[MCR] Anything about code snipets in RStudio? I don't use them so I'm not sure.
:::

...
With `knitr` engine, you can also override these per cell:
...
Like `fig-width` and `fig-height`, `fig-dpi` has no effect at the cell level with the Jupyter engine and must be set at the document or project level.
For knitr, it can be set per cell as `#| fig-dpi: 192`.
